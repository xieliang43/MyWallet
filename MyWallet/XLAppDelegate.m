...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    _rootController = [[XLRootViewController alloc] initWithNibName:nil bundle:nil];
    XLNavigationController *naviCon = [[XLNavigationController alloc] initWithRootViewController:_rootController];
